...
COLOR_MODES_LIMITLESS_WHITE = {COLOR_MODE_COLOR_TEMP}
SUPPORT_LIMITLESSLED_WHITE = SUPPORT_EFFECT | SUPPORT_TRANSITION
...
COLOR_MODES_LIMITLESS_RGBWW = {COLOR_MODE_COLOR_TEMP, COLOR_MODE_HS}
SUPPORT_LIMITLESSLED_RGBWW = SUPPORT_EFFECT | SUPPORT_FLASH | SUPPORT_TRANSITION
